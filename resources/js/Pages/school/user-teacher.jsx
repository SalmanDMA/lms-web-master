...
export default function SchoolUserTeacher() {
  const userTeacherColumns = [
    {
      accessorKey: "id",
      header: ({ column }) => {
        return (
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        function updateUserTeacherSubmit(e) {
          e.preventDefault()
          put("/admin/user", {
            onSuccess: () => {
        ...
        function deleteUserTeacherSubmit(e) {
          e.preventDefault()
          destroy("/admin/user", {
            onSuccess: () => {
              toast({
          ...
          <div className="flex items-center justify-end space-x-2">
            <Dialog open={dialogUpdate} onOpenChange={setDialogUpdate}>
              <DialogTrigger asChild>
                <Button
                  ...
                  onClick={() => setData({
                    ...
                    nip: row.original.is_teacher.nip,
              ...
              <DialogContent className="sm:max-w-[600px]">
                <form onSubmit={updateUserTeacherSubmit}>
                  <DialogHeader>
                    <DialogTitle>Ubah User Guru</DialogTitle>
                  </DialogHeader>
                    ...
                    <div className="grid grid-cols-5 gap-4">
                      ...
                      <div className="col-span-2 flex flex-col gap-2">
                        ...
                        <Input
                          ...
                          type="text"
                          placeholder="NIP"
                          defaultValue={row.original.is_teacher.nip}
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <form onSubmit={deleteUserTeacherSubmit}>
                    <input
                      type="hidden"
                      name="id"
  ...
  const { userTeacherData, title } = usePage().props
  const { data, setData, post, processing, errors, reset } = useForm({
    fullname: "", nip: "", email: "", phone: "", gender: "", religion: "",
    address: "", role: "", password: "", password_confirmation: "",
  })
  const { toast } = useToast()
  const [tableUserTeacherData, setTableUserTeacherData] = useState(userTeacherData)
  const [dialogCreate, setDialogCreate] = useState(false)

  function createUserTeacherSubmit(e) {
    e.preventDefault()
    post("/admin/user", {
      onSuccess: () => {
  ...
  useEffect(() => {
    setTableUserTeacherData(userTeacherData)
  }, [userTeacherData])

  return (
    <DefaultLayout path={"/admin/user-guru"} title={title}>
      <DataTable data={tableUserTeacherData} columnsData={userTeacherColumns}>
        <div className="flex justify-between">
          <CardTitle>Data User Guru</CardTitle>
          <Dialog open={dialogCreate} onOpenChange={setDialogCreate}>
            ...
            <DialogContent className="sm:max-w-[600px]">
              <form onSubmit={createUserTeacherSubmit}>
                <DialogHeader>
                  <DialogTitle>Tambah User Guru</DialogTitle>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-5 gap-4">
                    <div className="col-span-3 flex flex-col gap-2">
