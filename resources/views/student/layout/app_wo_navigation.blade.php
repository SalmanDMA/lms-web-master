...
<body>
    <div class="flex flex-col">
        ...
        <main class="bg-gray-100 flex flex-col justify-between gap-5 h-full p-4 items-center">
            <div class="mt-5 items-center flex justify-center w-full md:w-1/2 lg:w-4/6">
                @yield('content')
            </div>
        </main>
    </div>
