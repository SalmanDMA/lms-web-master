    ...
    <section class="section">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('staff_curriculum.soal_create') }}" class="btn btn-primary">Tambah</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($questionData as $question)
                            <tr>
                                ...
                                <td>
                                    @foreach ($schoolExamData as $ujian)
                                        @if ($ujian->id == $question->school_exam_id)
                                            {{ $ujian->id }} - {{ $ujian->title }}
                                        @endif
                                    @endforeach
                                </td>
                                ...
                                <td class="d-flex justify-content-center flex-nowrap">
                                    <a href="{{ route('staff_curriculum.soal_update', ['id' => $question->id]) }}"
                                        class="btn btn-primary me-1">Ubah</a>

                                    <form action="/staff-curriculum/question" method="POST"
