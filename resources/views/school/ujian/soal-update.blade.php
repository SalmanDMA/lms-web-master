            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-lg-end float-start">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/staff-curriculum/ujian/soal">Soal Ujian</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="/staff-curriculum/question" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <input type="hidden" name="id" id="id" value="{{ $questionData->id }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <select class="choices form-select" name="school_exam_id" id="school_exam_id"
                                    ...
                                    @foreach ($schoolExamData as $schoolExam)
                                        @if ($questionData->school_exam_id == $schoolExam->id)
                                            <option value="{{ $schoolExam->id }}" selected>
                            ...
                            <div class="form-group">
                                ...
                                <select class="choices form-select" name="section_id" id="section_id"
                                    ...
                                    @foreach ($examSectionData as $examSection)
                                        @if ($questionData->section_id == $examSection->id)
                                            <option value="{{ $examSection->id }}" selected>
                            ...
                            <div class="form-group">
                                ...
                                <select class="choices form-select" name="category_id" id="category_id"
                                    ...
                                    @foreach ($categoryQuestionData as $categoryQuestion)
                                        @if ($questionData->category_id == $categoryQuestion->id)
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="grade_method" id="grade_method"
                                    value="{{ $questionData->grade_method }}" required />
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="choices form-select" name="difficult" id="difficult"
                                    ...
                                    @foreach ($difficultyData as $difficult)
                                        @if ($questionData->difficult == $difficult)
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="point" id="point"
                                    value="{{ $questionData->point }}" required />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="question_text" id="question_text">{{ $questionData->question_text }}</textarea>
                    </div>
                    <div id="choices-inputs">
                        <div class="row align-items-center">
                            @foreach ($questionData->choices as $questionChoice)
                                @if ($questionData->question_type == 'Pilihan Ganda')
                                ...
                                @elseif ($questionData->question_type == 'Pilihan Ganda Complex')
                                    <div class="col-12 col-sm-10">
                                        <div class="form-group">
                                            <label for="choice_text" class="form-label">
                                                Pilihan {{ $loop->iteration }} <span class="text-danger">*</span>
                                ...
                                @elseif ($questionData->question_type == 'True False')
                                    @if ($loop->first)
