        ...
        <div class="card">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/admin/major" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name">Nama Jurusan</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Jurusan" value="{{ old('name') }}" required />
                                    </div>
            ...
            <div class="card-body">
                <table class="table" id="table">
                    ...
                    <tbody>
                        @foreach ($majorData as $jurusan)
                            <tr>
                                <td class="text-center"></td>
                                <td>{{ $jurusan->name }}</td>
                                <td class="d-flex justify-content-center flex-nowrap">
                                    <button type="button" class="btn btn-primary me-1" data-bs-toggle="modal"
                                        data-bs-target="#update-{{ $jurusan->id }}">
                                        Ubah
                                    </button>

                                    <form action="/admin/major" method="POST" onsubmit="return confirm('Hapus data?')">
                                        @method('DELETE')
                                        @csrf
                            ...
                            <div class="modal fade modal-borderless text-left" id="update-{{ $jurusan->id }}"
                                        ...
                                        <div class="modal-body">
                                            <form action="/admin/major" method="POST">
                                                ...
                                                <input type="hidden" name="id" id="id"
                                                    value="{{ $jurusan->id }}" required />

                                                <div class="form-group">
                                                    <label for="name">Nama Jurusan</label>
                                                    <input type="text" class="form-control" name="name"
                                                        id="name" placeholder="Jurusan"
                                                        value="{{ $jurusan->name }}" required />
                                                </div>
