                                ...
                                <form action="/admin/class" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Kelas" value="{{ old('name') }}" autofocus required />
                                    </div>
                ...
                <table class="table" id="table">
                    ...
                    <tbody>
                        @foreach ($classData as $kelas)
                            <tr>
                                ...
                                <td class="d-flex justify-content-center flex-nowrap">
                                    <button type="button" class="btn btn-primary me-1" data-bs-toggle="modal"
                                        data-bs-target="#update-{{ $kelas->id }}">
                                        Ubah
                                    </button>

                                    <form action="/admin/class" method="POST" onsubmit="return confirm('Hapus data?')">
                                        @method('DELETE')
                                        @csrf
                            ...
                            <div class="modal fade modal-borderless text-left" id="update-{{ $kelas->id }}"
