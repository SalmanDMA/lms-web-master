                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/admin/sub-class" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Sub Kelas" value="{{ old('name') }}" autofocus required />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="choices form-select" name="guardian" id="guardian"
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option value="{{ $teacher->fullname }}">{{ $teacher->fullname }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/admin/sub-class" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label for="name">Nama Sub Kelas<span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="guardian">Wali Kelas<span
                                                            class="text-danger"></span></label>
                                                    <select class="choices form-select" name="guardian"
                                                        id="guardian"
                                                        ...
                                                        @foreach ($teachers as $teacher)
                                                            <option value="{{ $teacher->fullname }}"
                                                                {{ old('guardian', $subKelas->guardian) == $teacher->fullname ? 'selected' : '' }}>
