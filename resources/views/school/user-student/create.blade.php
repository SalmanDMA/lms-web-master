<x-app-layout>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="choices form-select" name="class_id" id="class_id" value="{{ old('class_id') }}" required>
                ...
                <div class="form-group" id="subClassField" style="display: none;">
                    ...
                    <select class="choices form-select" name="sub_class_id" id="sub_class_id" value="{{ old('sub_class_id') }}" required>
    ...
    <script>
        ...
        document.getElementById('class_id').addEventListener('change', function() {
            ...
            const subClassField = document.getElementById('subClassField');
            ...
            if (selectedClassId) {
                ...
                const filteredSubClasses = subClassData.filter(subClass => subClass.class_id == selectedClassId);
                ...
                subClassField.style.display = filteredSubClasses.length > 0 ? 'block' : 'none';
            } else {
                subClassField.style.display = 'none';
            }
        });
    </script>
  </x-app-layout>
