...
<div id="question-main">
   ...
   <div class="col-md-6 mb-4">
    <div class="card border text-center">
     <div class="card-body">
      ...
      <a
       href="{{ route('teacher.pengajar.pembelajaran.v_add_soal', ['learning_id' => $learning_id, 'ulangan_id' => $class_exams->id]) }}"
     ...
     <div class="mb-3 me-2">
      <div class="dropdown">
       ...
       <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <li>
         <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#addFromBankModal">
      ...
      <tr>
       ...
       <td class="actions">
        <div class="d-flex justify-content-center gap-2">
         <a
          href="{{ route('teacher.pengajar.pembelajaran.v_edit_soal', ['learning_id' => $learning_id, 'ulangan_id' => $class_exams->id, 'soal_id' => $item->id]) }}"
       ...
       <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
         ...
         <div class="modal-footer">
          ...
          <form
           action="{{ route('teacher.pengajar.pembelajaran.delete_soal', ['learning_id' => $learning_id, 'ulangan_id' => $class_exams->id, 'soal_id' => $item->id]) }}"
           method="POST">
           @csrf
           @method('DELETE')
  ...
  <div class="modal-dialog modal-dialog-centered">
   <div class="modal-content">
    ...
    <div class="modal-footer">
     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
     <form id="formDelete"
      action="{{ route('teacher.pengajar.pembelajaran.delete_multiple_soal', ['learning_id' => $learning_id, 'ulangan_id' => $class_exams->id]) }}"
      method="POST">
      @csrf
      @method('DELETE')
 ...
 <div class="modal fade" id="addFromBankModal" tabindex="-1" aria-labelledby="addFromBankModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
   <div class="modal-content">
    <form
     action="{{ route('teacher.pengajar.pembelajaran.import_soal', ['learning_id' => $learning_id, 'ulangan_id' => $class_exams->id]) }}"
     method="POST">
     @csrf
     <div class="modal-header">
...
<script>
 $(document).ready(function() {
  ...
  const bankQuestions = @json($bank_questions);
