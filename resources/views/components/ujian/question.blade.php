@props(['questions', 'exams', 'bank_questions', 'class_levels', 'question_type', 'question_category'])
<div id="question-main">
      ...
      <div class="col-md-6 mb-4">
        <div class="card border text-center">
          <div class="card-body">
            ...
            <a href="{{ route('teacher.sekolah.v_add_soal', ['ujian_id' => $exams->id]) }}"
          ...
          <div class="mb-3 me-2">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li>
                  <a class="dropdown-item" href="{{ route('teacher.sekolah.v_add_soal', ['ujian_id' => $exams->id]) }}">
                    Buat Langsung
                  </a>
                </li>
                <li>
            ...
            <tr>
              ...
              <td class="actions">
                <div class="d-flex justify-content-center gap-2">
                  <a href="{{ route('teacher.sekolah.v_edit_soal', ['ujian_id' => $exams->id, 'soal_id' => $item->id]) }}"
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <form
                      action="{{ route('teacher.sekolah.delete_soal', ['ujian_id' => $exams->id, 'soal_id' => $item->id]) }}"
                      method="POST">
                      @csrf
                      @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
          <form id="formDelete"
            action="{{ route('teacher.sekolah.delete_multiple_soal', ['ujian_id' => $exams->id]) }}" method="POST">
            @csrf
            @method('DELETE')
  ...
  <div class="modal fade" id="addFromBankModal" tabindex="-1" aria-labelledby="addFromBankModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <form action="{{ route('teacher.sekolah.import_soal', ['ujian_id' => $exams->id]) }}" method="POST">
          @csrf
          <div class="modal-header">
