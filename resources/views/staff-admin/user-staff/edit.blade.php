          ...
          <div class="row">
              ...
              <div class="col-12 col-md-6 order-md-2 order-first">
                  <nav aria-label="breadcrumb" class="breadcrumb-header float-lg-end float-start">
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{{ route('staff_administrator.staff') }}">Daftar Staff</a></li>
          ...
          <div class="card-body">
              ...
              <form action="/staff-administrator/user" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nip" id="nip" placeholder="NIP" value="{{ $user->is_staff?->nip }}" required />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="placement" id="placement" placeholder="Penempatan" value="{{ $user->is_staff?->placement }}" required />
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="choices form-select" name="authority" id="authority" value="{{ old('authority') }}" required>
                      ...
                      <option value="KURIKULUM" {{ $user->is_staff?->authority == 'KURIKULUM' ? 'selected' : '' }}>Kurikulum</option>
                      <option value="ADMIN" {{ $user->is_staff?->authority == 'ADMIN' ? 'selected' : '' }}>Admin</option>
                  </select>
                </div>
