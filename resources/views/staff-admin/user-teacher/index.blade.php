    ...
    <section class="section">
      <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ route('staff_administrator.guru_create') }}" class="btn btn-primary">Tambah</a>
        </div>
        <div class="card-body">
                    ...
                    @foreach ($userTeacherData as $user)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center flex-nowrap">
                                <a href="{{ route('staff_administrator.guru_update', ['id' => $user->id]) }}" class="btn btn-primary me-1">
                                    Ubah
                                </a>
