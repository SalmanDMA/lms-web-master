  ...
  <section class="section">
      <div class="card">
          <div class="card-header d-flex justify-content-between">
              ...
              <a href="{{ route('staff_curriculum.ujian_create') }}" class="btn btn-primary">Tambah</a>
          </div>
          <div class="card-body">
                    ...
                    @foreach ($exams as $exam)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center flex-nowrap">
                                <a href="{{ route('staff_curriculum.ujian_update', ['id' => $exam->id]) }}" class="btn btn-primary me-1">Ubah</a>

                                <form action="/staff-administrator/school-exam" method="POST"
                                    onsubmit="return confirm('Hapus data?')">
                                    @method('DELETE')
                                    @csrf
                                    <input type="hidden" name="id" id="id" value="{{ $exam->id }}" required />
