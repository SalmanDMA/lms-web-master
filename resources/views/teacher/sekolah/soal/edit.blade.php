<x-app-layout>
  ...
  <div class="card mt-3" id="mainCard">
    ...
    <div class="card-body mt-3">
      <form id="main-form"
        action="{{ route('teacher.sekolah.edit_soal', ['ujian_id' => $ujian_id, 'soal_id' => $soal_id]) }}"
                      ...
                      <tr id="resource-row-{{ $index }}" data-id="{{ $resource->id }}">
                        ...
                        <td>
                          ...
                          @elseif ($resource->file_type === 'archive')
                            <a href="{{ route('teacher.sekolah.download_soal', ['ujian_id' => $ujian_id, 'soal_id' => $resource->id]) }}"
          ...
          <div class="tab-content" id="categoryTabContent">
            ...
            <div class="tab-pane fade" id="add" role="tabpanel" aria-labelledby="add-tab">
              <form id="addCategoryForm" class="mt-3" method="POST"
                action="{{ route('teacher.add_soal_kategori') }}">
                @csrf
                <div class="mb-3">
