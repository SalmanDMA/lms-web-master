<x-app-layout>
 ...
 <div class="card mt-3" id="mainCard">
  ...
  <div class="card-body mt-3">
   <form id="main-form" action="{{ route('teacher.bank.edit_soal', ['id' => $question_bank->id]) }}" method="POST"
           ...
           <tr id="resource-row-{{ $index }}" data-id="{{ $resource->id }}">
            ...
            <td>
             ...
             @elseif ($resource->file_type === 'archive')
              <a href="{{ route('teacher.bank.download_soal', $resource->id) }}" class="btn btn-success">Unduh</a>
             @else
              @php
