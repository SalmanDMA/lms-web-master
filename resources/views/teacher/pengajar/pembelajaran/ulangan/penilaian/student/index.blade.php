                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                      ...
                      Nilai Akhir</button>
                    <a href="{{ route('teacher.pengajar.pembelajaran.v_penilaian_ulasan', ['learning_id' => $learning_id, 'ulangan_id' => $ulangan_id, 'student_id' => str_replace('/', '-', $student['student_id']), 'response_id' => $attempt['response_id']]) }}"
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form
                          action="{{ route('teacher.pengajar.pembelajaran.update_is_main', ['learning_id' => $learning_id, 'ulangan_id' => $ulangan_id, 'student_id' => str_replace('/', '-', $student['student_id']), 'response_id' => $attempt['response_id']]) }}"
                          method="POST">
                          @csrf
                          @method('PUT')
