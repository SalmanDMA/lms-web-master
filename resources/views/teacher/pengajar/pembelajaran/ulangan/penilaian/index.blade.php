        ...
        <div class="card col-12 col-md-3 mb-3 mb-md-0">
          ...
          <div class="card-body border rounded">
            <h3 class="mb-0 mt-3 fs-1 text-center fw-bolder">
              {{ $total_user_responses }} / {{ $class_exams->exam_setting->maximum_user }}
            </h3>
          </div>
        </div>
        <div class="card col-12 col-md-3 mb-3 mb-md-0">
            ...
            <tbody>
              @forelse($student_reports as $report)
                <tr data-status="{{ is_null($report['final_grade']) ? 'belum_dinilai' : 'sudah_dinilai' }}">
                  ...
                  <td>
                    <a href="{{ route('teacher.pengajar.pembelajaran.v_penilaian_student', ['learning_id' => $learning_id, 'ulangan_id' => $ulangan_id, 'student_id' => str_replace('/', '-', $report['student_id'])]) }}"
