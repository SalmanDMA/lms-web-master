<x-app-layout>
  ...
  <div class="card mt-3" id="mainCard">
    ...
    <div class="card-body mt-3">
      <form id="main-form"
        action="{{ route('staff_curriculum.sekolah.edit_soal', ['id' => $ujian_id, 'section_id' => $section_id, 'soal_id' => $soal_id]) }}"
            ...
            <div class="row mb-3">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <select class="form-select" id="difficult" name="difficult">
                  ...
                  <option value="Sangat Mudah" {{ $question->difficult == 'Sangat Mudah' ? 'selected' : '' }}>Sangat
                    Mudah
                  </option>
                  ...
                  <option value="Sulit" {{ $question->difficult == 'Sulit' ? 'selected' : '' }}>
                    Sulit</option>
                  <option value="Sangat Sulit" {{ $question->difficult == 'Sangat Sulit' ? 'selected' : '' }}>Sangat
                    Sulit
                  </option>
                </select>
              </div>
              ...
              <div class="col-md-6 mb-3">
                <label for="section_id" class="form-label">Section Soal<span class="text-danger">*</span></label>
                <div class="input-group">
                  <select class="form-select" id="section_id" name="section_id">
                    <option value="" selected>- Pilih Section -</option>
                    @foreach ($exam_sections as $item)
                      <option value="{{ $item->id }}" {{ $item->id == $question->section_id ? 'selected' : '' }}>
                        {{ $item->name }}</option>
                    @endforeach
                  </select>
                </div>
                      ...
                      <tr id="resource-row-{{ $index }}" data-id="{{ $resource->id }}">
                        ...
                        <td>
                          ...
                          @elseif ($resource->file_type === 'archive')
                            <a href="{{ route('staff_curriculum.sekolah.download_soal', ['id' => $ujian_id, 'section_id' => $section_id, 'section_id' => $section_id, 'soal_id' => $resource->id]) }}"
