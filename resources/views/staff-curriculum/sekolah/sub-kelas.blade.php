                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/staff-curriculum/sub-class" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="name">Nama Sub Kelas</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="guardian" id="guardian"
                                            placeholder="Wali Kelas" value="{{ old('guardian') }}" required />
                                    </div>
                                            ...
                                            <form action="/staff-curriculum/sub-class" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="guardian"
                                                        id="guardian" placeholder="Wali Kelas"
                                                        value="{{ $subKelas->guardian }}" required />
                                                </div>
