            ...
            <tbody>
              @forelse ($student['attempts_history'] ?? [] as $attempt)
                <tr>
                  ...
                  <td>
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalNilaiAkhir{{ $attempt['response_id'] }}">Jadikan Nilai Akhir</button>
                    <a href="{{ route('staff_curriculum.sekolah.v_penilaian_ulasan', ['id' => $school_exam_id, 'student_id' => str_replace('/', '-', $student['student_id']), 'response_id' => $attempt['response_id']]) }}"
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form
                          action="{{ route('staff_curriculum.sekolah.update_is_main', ['id' => $school_exam_id, 'student_id' => str_replace('/', '-', $student['student_id']), 'response_id' => $attempt['response_id']]) }}"
                          method="POST">
                          @csrf
                          @method('PUT')
