            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 my-4 border">
                    <x-datatable title="Siswa Tidak Terdaftar">
                        <form id="form-left"
                            action="{{ route('staff_curriculum.class.enroll_student', ['sub_class_id' => $sub_class_id, 'course_id' => $course_id]) }}"
                            method="POST">
                            @csrf
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                ...
                                                <input type="hidden" name="teacher_id"
                                                    value="{{ $filteredTeacher->is_teacher->id }}">
                                            </td>
                ...
                <div class="col-12 col-md-6 my-0 my-md-4 border">
                    <x-datatable title="Siswa Terdaftar">
                        <form id="form-right"
                            action="{{ route('staff_curriculum.class.unenroll_student', ['sub_class_id' => $sub_class_id, 'course_id' => $course_id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3 d-flex justify-content-end align-items-center">
