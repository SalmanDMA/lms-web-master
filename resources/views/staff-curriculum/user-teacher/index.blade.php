    ...
    <section class="section">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('staff_curriculum.guru_create') }}" class="btn btn-primary">Tambah</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($userTeacherData as $user)
                            <tr>
                                ...
                                <a href="{{ route('staff_curriculum.guru_update', ['id' => $user->id]) }}" class="btn btn-primary me-1">
                                    Ubah
                                </a>
