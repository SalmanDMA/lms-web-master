<x-app-layout>
    ...
    <div class="card mt-3" id="mainCard">
     ...
     <div class="card-body mt-3">
      <form id="main-form" action="{{ route('staff_curriculum.bank.add_soal') }}" method="POST" enctype="multipart/form-data">
       @csrf
        ...
        <div class="tab-pane fade" id="resources" role="tabpanel" aria-labelledby="resources-tab">
         ...
         <div class="d-flex justify-content-end gap-2 mt-2">
          <a href="{{ url()->previous() }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i>
           Kembali</a>
          <button type="button" class="btn btn-success" onclick="addResource()"> <i class="bi bi-plus-lg"></i> Tambah
           Lampiran</button>
