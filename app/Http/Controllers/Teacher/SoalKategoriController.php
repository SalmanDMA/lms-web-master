...
class SoalKategoriController extends Controller
{
    ...
    public function add_soal_kategori(Request $request)
    {
        ...
        $response_data = $this->postData('/api/v1/cms/teacher/category-question', $data, 'json');
    ...
    public function edit_soal_kategori(Request $request, $id)
    {
        ...
        $response_data = $this->putData('/api/v1/cms/teacher/category-question/' . $id, $data, 'json');
    ...
    {
        $response_data = $this->deleteData('/api/v1/cms/teacher/category-question/' . $id);
    ...
    private function handle_response($response_data, $type)
    {
        ...
        $question_category = $this->fetchData('/api/v1/cms/teacher/category-question');
