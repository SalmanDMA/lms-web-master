...
class SubjectMatterRppController extends Controller
{
    use CommonTrait;

    public function index($rpp_id)
    {
        $subjectMatters = SubjectMatter::where('rpp_id', $rpp_id)->get();
